...
class Router implements RegistrarContract, BindingRegistrar
{
    ...
    public function auth()
    {
        ...
        // Registration Routes...
        $this->get('register/{recruiter_name?}', 'Auth\RegisterController@showRegistrationForm')->name('register');
        $this->get('register/verify/{email}/{verify_token}', 'Auth\RegisterController@sendEmailDone')->name('register.verify');
