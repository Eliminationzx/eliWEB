            ...
            <div class="col-lg-12">
                ...
                <div class="ibox">
                    <div class="ibox-title">
                        <h5>Search results ({{count($shopitems)}})</h5>
                    </div>
                    <div class="ibox-content">
                        <div class="project-list">
                            <div class="row">
                                    @forelse ($shopitems as $shopitem)
                                    <div class="col-md-3" id="{{ $shopitem['id'] }}">
                                        <div class="ibox">
                                            <div class="ibox-content product-box">
                                                ...
                                                <wow-tooltip-content
                                                   ...
                                                   data-shopitem-delay="{{$shopitem['delay'] == 0 ? '' : 'Veloc. '.$shopitem['delay']}}"
                                                   ...
                                                   data-shopitem-itemlevel="{{$shopitem['itemlevel'] == 0 ? '' : 'Уровень предмета: '.$shopitem['itemlevel']}}"
                                                   data-shopitem-requiredlevel="{{$shopitem['requiredlevel'] == 0 ? '' : 'Требуемый уровень: '.$shopitem['requiredlevel']}}"
                                                   ...
                                                   data-shopitem-spell1="{{empty($shopitem['spell_1']) ? '' : $shopitem['spell_1']['Description_ru_ru']}}"
                                                   data-shopitem-spell2="{{empty($shopitem['spell_2']) ? '' : $shopitem['spell_2']['Description_ru_ru']}}"
                                                   data-shopitem-spell3="{{empty($shopitem['spell_3']) ? '' : $shopitem['spell_3']['Description_ru_ru']}}"
                                                   data-shopitem-spell4="{{empty($shopitem['spell_4']) ? '' : $shopitem['spell_4']['Description_ru_ru']}}"
                                                   data-shopitem-spell5="{{empty($shopitem['spell_5']) ? '' : $shopitem['spell_5']['Description_ru_ru']}}">
                                                ...
                                                <div class="product-desc">
                                                    <span class="product-price">
                                                        @if ($shopitem['rnd_discount'] > 0)
                                                          {{ '-'.$shopitem['rnd_discount'].'% ' }}<del>{{ $shopitem['price'] }} PD</del> {{ ceil($shopitem['price'] * (100 - $shopitem['rnd_discount']) / 100) }} PD {{ $shopitem['count'] > 1 ? 'for '.$shopitem['count'] : '' }} 
                                                        @else
                                                    ...
                                                    <div class="m-t text-righ">
                                                        <form action="{{ route('admin.shop.update') }}" method="POST" role="form">
                                                        ...
                                                        <br>
                                                        <form action="{{ route('shop.payments') }}" method="POST" role="form">
                                                            <input type="hidden" name="id" value="{{ $shopitem['id'] }}">
                                                            <input type="hidden" name="_token" id="token" value="<?php echo csrf_token(); ?>">
