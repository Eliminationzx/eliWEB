        ...
        <form method="POST" action="{{ route('shop.search') }}"
            ...
            <input type="hidden" name="_token" id="token" value="<?php echo csrf_token(); ?>">
                <div class="input-group">
                    <input type="text" name="searchstr" class="form-control" value="" placeholder="Ingrese el nombre o la ID del artículo ...">
                ...
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        <div class="project-list">
                            ...
                            @foreach($shopitems_discount as $shopitemarr)
                                    <div class="item {{ $loop->first ? 'active' : '' }}">
                                    @foreach($shopitemarr as $shopitem)
                                    <div class="col-md-3" id="{{ $shopitem['id'] }}">
                                        <div class="ibox">
                                            <div class="ibox-content product-box">
                                                   ...
                                                   data-shopitem-allowablerace="{{!empty($shopitem['allowablerace']) ? 'Razas: '.$shopitem['allowablerace'] : ''}}"
                                                ...
                                                <div class="product-desc">
                                                    <span class="product-price">
                                                        ...
                                                        @else
                                                          {{ $shopitem['price'] }} PD {{ $shopitem['count'] > 1 ? 'за '.$shopitem['count'] : '' }}  
                                                        @endif
                                                    </span>
            ...
            <div class="col-lg-12">
                <div class="ibox">
                     <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            <a href="{{ route('admin.shop.formcreate') }}" class="btn btn-primary btn-xs"><i
                                        class="fa fa-plus"></i> Añadir item
                            </a>
                        </div>
                        @endpermission
                    </div>
                                        ...
                                        <div class="ibox">
                                            <div class="ibox-content product-box">
                                                ...
                                                <div class="product-desc">
                                                    <span class="product-price">
                                                        @if ($shopitem->rnd_discount > 0)
                                                          {{ '-'.$shopitem->rnd_discount.'% ' }}<del>{{ $shopitem->price }} PD</del> {{ ceil($shopitem->price * (100 - $shopitem->rnd_discount) / 100) }} PD {{ $shopitem->count > 1 ? 'за '.$shopitem->count : '' }} 
                                                        @else
