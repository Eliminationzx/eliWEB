                        ...
                        <div class="project-list">
                            <div class="col-lg-12">
									...
									<div class="alert alert-success">
                                        En tu cuenta hay {{$data->donate }} Puntos de Donación (PD)
                                    </div>
                                </div>
                                <h2>Donacion via <span class="badge badge-secondary">PayPal</span></h2>
                                <div class="alert alert-info" role="alert">
                                    1 {{$currency->value}} = {{ceil(1/$price->value)}} Puntos De Donación (PD)
                                </div>
								<form method="POST" class="form-horizontal" enctype="multipart/form-data">
                                <input type="hidden" name="_token" id="token" value="<?php echo csrf_token(); ?>">
								<input type="hidden" id="price" value="{{ $price->value }}" type="text">							
								<div class="form-group">
                                    <label class="col-sm-3">Monto de donación en ({{$currency->value}}):</label>
                                    <div class="col-sm-9">
