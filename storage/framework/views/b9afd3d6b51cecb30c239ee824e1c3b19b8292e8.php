					...
					<div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            <a href="<?php echo e(route('admin.launcher.videos.create')); ?>" class="btn btn-primary btn-xs"><i
                                        class="fa fa-plus"></i> Добавить видео
                            </a>
                        </div>
                        ...
                        <div class="project-list">
                            ...
                            <table class="table table-hover">
                                <tr>
                                    ...
                                    <th style="border-top: 1px solid #ffffff;">Ссылка на видео</th>
                                    ...
                                    <tr id="<?php echo e($video->id); ?>">
                                        ...
                                        <td class="project-title">
                                            <small><?php if($video->updated_at == $video->created_at): ?>
                                                    Создана <?php echo e($video->created_at); ?>

                                                <?php else: ?>
                                                    Обновлена <?php echo e($video->updated_at); ?>
