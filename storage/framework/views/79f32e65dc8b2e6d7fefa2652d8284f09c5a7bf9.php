    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-sm-4">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <strong>Cambio de facción</strong>
                </li> 
            </ol>
        </div>
    </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="ibox">
					<div class="ibox-title">
						<h5>Formulario para el cambio de facción de personaje</h5>
					</div>
                    <div class="ibox-content">
                        ...
                        <div class="project-list">
                            <form method="POST" action="<?php echo e(route('characters.faction')); ?>"
                                ...
                                <button type="submit" class="btn btn-block btn-outline btn-primary">Cambio de facción por <?php echo e($price->value); ?> PD</button>
                            </form>
                        </div>
                    </div>
                </div>
