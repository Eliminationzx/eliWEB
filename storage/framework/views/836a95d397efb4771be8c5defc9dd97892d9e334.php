    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-sm-4">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <strong>Починка персонажа</strong>
                </li> 
            </ol>
        </div>
    </div>
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="project-list">
                            <form method="POST" action="<?php echo e(route('characters.repair')); ?>"
                                ...
                                <button type="submit" class="btn btn-block btn-outline btn-primary">Починить</button>
                            </form>
                        </div>
                    </div>
                </div>
