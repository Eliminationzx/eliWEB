            ...
            <div class="col-lg-12">
                ...
                <div class="ibox">
					<div class="ibox-title">
						<h5>Форма смены имени персонажа</h5>
					</div>
                    <div class="ibox-content">
                        ...
                        <div class="project-list">
                            <form method="POST" action="<?php echo e(route('characters.name')); ?>"
                                ...
                                <button type="submit" class="btn btn-block btn-outline btn-primary">Сменить имя за <?php echo e($price->value); ?> навлонов</button>
                            </form>
                        </div>
                    </div>
                </div>
