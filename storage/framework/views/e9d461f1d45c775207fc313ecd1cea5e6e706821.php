            ...
            <div class="col-lg-12">
                ...
                <div class="ibox">
					<div class="ibox-title">
						<h5>Форма активации промокода</h5>
					</div>
                        ...
                        <div class="project-list"> 
                            <div class="col-lg-12">
                                    <div class="panel panel-primary">
                                        ...
                                        <div class="panel-body">
                                            <p>Наш проект старается как можно чаще радовать своих игроков бесплатными подарками и ценными призами, которые можно получить автоматически на вашего персонажа за специальные промокоды.</p>
                                            <p><b>Примечание:</b> Следите за новостями проекта, там вы сможете найти множество промокодов, которые мы разыграем или раздадим бесплатно.</p>
                                        </div>
                                    </div>
                                </div>
                            <form method="POST" action="/personal/promocodes"
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3">Ваш промокод:</label>
                                    <div class="col-sm-9">
                                        <div class="input-group col-sm-12">
                                            <input type="text" class="form-control" name="promocode" id="promocode" value="" placeholder="Введите промокод...">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <button type="submit" class="btn btn-block btn-outline btn-primary">Активировать</button>
                            </form>
                        </div>
                    </div>
                </div>
