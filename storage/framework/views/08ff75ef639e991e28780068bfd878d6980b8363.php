        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form action="<?php echo e(route('admin.roles.create')); ?>" method="POST" role="form">
                        ...
                        <div class="form-group text-left">
                            ...
                            <?php $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="i-checks"><label> <input type="checkbox"   name="permission[]" value="<?php echo e($permission->id); ?>"> <i></i> <?php echo e($permission->display_name); ?> </label></div>
