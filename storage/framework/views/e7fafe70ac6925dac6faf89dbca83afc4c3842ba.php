            ...
            <div class="modal-dialog">
                <div class="modal-content animated flipInY">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Резервная копия создаётся</h4>
                        <small class="font-bold">Это может занять какое то время.</small>
                    </div>
                    <div class="modal-body">
                        <p>Вы можете закрыть данное окно резервная копия будет создана в фоновом режиме и появится через некоторое время.</p>
                    </div>
					...
					<div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            ...
                            <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#myModal2" onclick="createbackup(<?php echo e(route('admin.backups.create')); ?>)"><i
                                        class="fa fa-plus"></i> Создать резервную копию
                            </button>
                        </div>
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="project-list">
                            ...
                            <table class="table table-hover">
                                <tr>
                                    <th style="border-top: 1px solid #ffffff;">Дата создания</th>
                                </tr>
                                <tbody>
                                        ...
                                        <td class="project-actions">
                                            <form action="editnews" method="POST" role="form">
                                                ...
                                                <a href="<?php echo e(route('admin.backups.file', ['file' => $backup])); ?>"
                                                   class="btn btn-success btn-sm" target="_blank"><i class="fa fa-arrow-down"></i> Cкачать
                                                </a>
                                                <?php endif; // Entrust::can ?>
