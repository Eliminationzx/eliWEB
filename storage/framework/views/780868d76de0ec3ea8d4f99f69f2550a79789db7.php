...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-sm-12">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <strong>Топы голосования</strong>
            </li> 
         </ol>
    </div>
</div>
                        ...
                        <div class="project-list">
                            ...
                            <table class="table table-hover">
                                <tr>
                                    ...
                                    <th style="border-top: 1px solid #ffffff;">Описание</th>
                                    <th style="border-top: 1px solid #ffffff;">Изображение</th>
                                    <th style="border-top: 1px solid #ffffff;">Награда</th>
                                ...
                                <?php $__currentLoopData = $votes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vote): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr id="<?php echo e($vote->id); ?>">
										...
										<td class="project-title">
                                            <?php echo e($vote->reward); ?> Н
                                        </td>

                                        <td class="project-title">
                                            <small>
                                                    Создан: <?php echo e($vote->created_at); ?>

<br>
                                                    Обновлен: <?php echo e($vote->updated_at); ?>
