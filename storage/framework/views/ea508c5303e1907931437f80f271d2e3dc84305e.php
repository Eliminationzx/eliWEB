            ...
            <div class="col-lg-12">
                ...
                <div class="ibox">
					<div class="ibox-title">
						<h5>Formulario para el cambio de la raza del personaje.</h5>
					</div>
                    <div class="ibox-content">
                        ...
                        <div class="project-list">
                            <form method="POST" action="<?php echo e(route('characters.race')); ?>"
                                ...
                                <button type="submit" class="btn btn-block btn-outline btn-primary">Cambio de raza por <?php echo e($price->value); ?> PD</button>
                            </form>
                        </div>
                    </div>
                </div>
