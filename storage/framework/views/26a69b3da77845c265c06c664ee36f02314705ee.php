...
<?php $__env->stopSection(); ?>
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-sm-12">
            <h2>Bienvenido <?php echo e($data->name); ?></h2>
        </div>
        <div class="col-lg-6">
        ...
        <div class="col-lg-6">
            <div class="widget style1 gray-bg">
                <div class="row">
                    ...
                    <div class="col-xs-10 text-right">
                        <h3>Saldo actual</h3>   
                        <h2 class="font-bold"><?php echo e($data->donate); ?> PD /  <?php echo e($data->vote); ?> PV</h2>
                        <a href="<?php echo e(route('donate')); ?>" class="btn btn-xs btn-outline btn-white"> Donar </a>
                        <a href="<?php echo e(route('votes')); ?>" class="btn btn-xs btn-outline btn-white"> Votar </a>
                    </div>
        ...
        <div class="col-lg-6">
            ...
            <div class="widget style1 yellow-bg">
                <div class="row">
                    ...
                    <div class="col-xs-10 text-right">
                        <h3>Estado premium rango <?php echo e($premiuminfo[0]['premium_type']); ?></h3>
                        <h2 class="font-bold">Activo</h2>
                        <h3 class="font-bold">Hasta <?php echo e(date("d-m-Y H:i:s", $premiuminfo[0]['unsetdate'])); ?> </h3>
                    </div>
            ...
            <div class="widget style1 gray-bg">
                <div class="row">
                    ...
                    <div class="col-xs-10 text-right">
						 ...
						 <h4 class="font-bold">Último acceso <?php echo e($accgameinfo[0]['last_login']); ?> IP <?php echo e($accgameinfo[0]['last_ip']); ?></h4>
                    </div>
    ...
    <div class="chat-message left">
        <div class="message">
            ...
            <span class="message-content">
                ...
                <a href="<?php echo e(route('referals')); ?>" class="btn btn-block btn-outline btn-primary">Términos del sistema de referencia</a>
            </span>
        </div>
    </div>
                        ...
                        <div class="ibox-title">
                            <div class="ibox-tools">
                                <a class="collapse-link">
                                    <h5 style="color: #333234">Lista de personajes (<?php echo e($userinfo == null ? 0 : count($userinfo)); ?>)</h5>
                                </a>
                                <a class="collapse-link">
												...
												<div class="ibox-content product-box">
													...
													<div class="product-imitation" style="background: url(<?php echo e(URL::asset('admin/img/faction/'.$userinfos->factionid.'.png')); ?>) left top no-repeat;"> 
                                                        <wow-tooltip-charinfo-content 
															data-charinfo-faction="<?php echo e('Faction: '.($userinfos->factionid == 0 ? 'Alliance' : 'Horde')); ?>"
                                                            ...
                                                            <div class="tooltip-icon">
                                                                ...
                                                                <img alt="image" class="tooltip-icon-adt" src="<?php echo e(URL::asset('admin/img/class/'.$userinfos->class.'.png')); ?>">
                                                            </div>
														</wow-tooltip-charinfo-content>
													</div>
											...
											<div class="ibox">
												<div class="ibox-content product-box">
													...
													<div class="dropdown">
                                                        ...
                                                        <wow-tooltip-charinfo-content 
															data-charinfo-faction="<?php echo e('Faction: '.($recruiterinfos->factionid == 0 ? 'Alliance' : 'Horde')); ?>"
