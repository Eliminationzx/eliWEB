            ...
            <div class="col-lg-12">
                ...
                <div class="ibox">
					<div class="ibox-title">
						<h5>Character fraction change form</h5>
					</div>
                    <div class="ibox-content">
                        ...
                        <div class="project-list">
                            <form method="POST" action="<?php echo e(route('characters.race')); ?>"
                                ...
                                <button type="submit" class="btn btn-block btn-outline btn-primary">Change the faction for <?php echo e($price->value); ?> D</button>
                            </form>
                        </div>
                    </div>
                </div>
