       ...
       <form method="POST" action="<?php echo e(route('shop.search')); ?>"
            ...
            <input type="hidden" name="_token" id="token" value="<?php echo csrf_token(); ?>">
                    ...
                    <div class="input-group">
                        <input type="text" name="searchstr" class="form-control" value="" placeholder="Введите имя или ID товаров...">
            ...
            <div class="col-lg-12">
                ...
                <div class="ibox">
                    <div class="ibox-title">
                        <h5>Результаты поиска (<?php echo e(count($shopitems)); ?>)</h5>
                    </div>
                                                ...
                                                <div class="product-desc">
                                                    <span class="product-price">
                                                        <?php if($shopitem['rnd_discount'] > 0): ?>
                                                          <?php echo e('-'.$shopitem['rnd_discount'].'% '); ?><del><?php echo e($shopitem['price']); ?> Н</del> <?php echo e(ceil($shopitem['price'] * (100 - $shopitem['rnd_discount']) / 100)); ?> Б <?php echo e($shopitem['count'] > 1 ? 'за '.$shopitem['count'].'шт.' : ''); ?> 
                                                        <?php else: ?>
                                                          <?php echo e($shopitem['price']); ?> Н <?php echo e($shopitem['count'] > 1 ? 'за '.$shopitem['count'].'шт.' : ''); ?>  
                                                        <?php endif; ?>
                                                    </span>
                                                    ...
                                                    <div class="m-t text-righ">
                                                        <form action="<?php echo e(route('admin.shop.update')); ?>" method="POST" role="form">
                                                            ...
                                                            <button class="btn btn-xs btn-outline btn-danger pull-right delete" data-element-id="<?php echo e($shopitem['id']); ?>" data-method-post="<?php echo e(route('admin.shop.delete')); ?>" onclick="return false;" >Удалить <i
                                                        ...
                                                        <form action="<?php echo e(route('shop.payments')); ?>" method="POST" role="form">
                                                            ...
                                                            <button class="btn btn-xs btn-outline btn-block btn-primary ">Купить</button>
