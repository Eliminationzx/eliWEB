                ...
                <div class="ibox-content">
                    ...
                    <form action="<?php echo e(route('admin.launcher.news.update')); ?>" method="POST" role="form" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="title" value="<?php echo e($news->title); ?>" placeholder="Title...">
                        </div>
                        
                        <div class="form-group">
                            <label for="body">Content</label>
                            <textarea type="text" class="form-control" name="body" placeholder="Content..."><?php echo e($news->body); ?></textarea>
                        </div>
