                        ...
                        <div class="project-list">
                            <form method="POST" action="<?php echo e(route('accounts.passwords')); ?>"
                                ...
                                <div class="form-group">
                                    <label class="col-sm-12 b-r-xl">Старый пароль:</label>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-12">Подтвердите пароль:</label>
                                ...
                                <div class="form-group ">
                                    <div class="col-sm-12">
                                        <button class="btn btn-block btn-outline btn-primary">Сохранить</button>
                                    </div>
                                </div>
                            </form>
                        </div>
