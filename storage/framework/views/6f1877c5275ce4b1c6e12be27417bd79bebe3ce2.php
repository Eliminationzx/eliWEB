                                        ...
                                        <div class="input-group col-sm-12">
                                            <div>
                                                <select name="guid" data-placeholder="Elige un personaje ..." class="chosen-select"  tabindex="2">
													<?php if($deletedcharinfo != null): ?>
														<?php $__currentLoopData = $deletedcharinfo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deletedcharinf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
															<option value="<?php echo e($deletedcharinf->guid.','.$deletedcharinf->realm_id); ?>"><?php echo e($deletedcharinf->name); ?> (<?php echo e($deletedcharinf->realm_name); ?>)</option>
