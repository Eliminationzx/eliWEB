            ...
            <div class="col-lg-12">
                ...
                <div class="ibox">
					<div class="ibox-title">
						<h5>Formulario para el cambio de nombre de personaje</h5>
					</div>
                    <div class="ibox-content">
                        ...
                        <div class="project-list">
                            <form method="POST" action="<?php echo e(route('characters.name')); ?>"
                                ...
                                <button type="submit" class="btn btn-block btn-outline btn-primary">Cambiar nombre por <?php echo e($price->value); ?> PD</button>
                            </form>
                        </div>
                    </div>
                </div>
