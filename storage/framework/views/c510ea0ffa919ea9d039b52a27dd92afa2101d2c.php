...
<?php $__env->stopSection(); ?>
    <div class="middle-box text-center loginscreen animated fadeInDown ">
         <div>
            ...
            <h3>Запрос на восстановление пароля</h3>
            ...
            <form class="m-t" method="POST" action="<?php echo e(url('/password/email')); ?>">
                ...
                <p class="text-muted text-center">
                    <small>У вас нет акаунта?</small>
                </p>
                <a class="btn btn-sm btn-white btn-block" href="<?php echo e(url('/register')); ?>">Создать акаунт</a>
				<p class="text-muted text-center">
