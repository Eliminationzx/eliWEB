                                ...
                                <div class="col-lg-12">
                                    <div class="panel panel-primary">
                                        ...
                                        <div class="panel-body">
                                            <p>На текущий период времени вы можете приобрести игровое золото по курсу <b><?php echo e($price->value); ?>:1</b></p>
                                        </div>
                                    </div>
                                </div>
                            <form method="POST" action="<?php echo e(route('currency.gold')); ?>" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group col-sm-12">
                                            <div>
                                                <input type="text" onfocus="calculate(this)" class="form-control" name="cur_count" id="cur_count" value="" placeholder="Введите количество золота...">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group col-sm-12">
                                            <div>
                                                <input type="text" onfocus="calculate(this)" class="form-control" name="bp_count" id="bp_count" value="" placeholder="Введите количество навлонов...">
                                            </div>
                                        </div>
                                    </div>
                                </div>
