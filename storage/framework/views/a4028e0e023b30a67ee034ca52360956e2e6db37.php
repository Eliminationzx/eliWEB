                                    ...
                                    <div class="col-md-3" id="<?php echo e($shopitem['id']); ?>">
                                        <div class="ibox">
                                            <div class="ibox-content product-box">
                                                   ...
                                                   data-shopitem-allowablerace="<?php echo e(!empty($shopitem['allowablerace']) ? 'Razas: '.$shopitem['allowablerace'] : ''); ?>"
                                                ...
                                                <div class="product-desc">
                                                    <span class="product-price">
                                                        ...
                                                        <?php else: ?>
                                                          <?php echo e($shopitem['price']); ?> PD <?php echo e($shopitem['count'] > 1 ? 'за '.$shopitem['count'] : ''); ?>  
                                                        <?php endif; ?>
                                                    </span>
                                        ...
                                        <div class="ibox">
                                            <div class="ibox-content product-box">
                                                ...
                                                <div class="product-desc">
                                                    <span class="product-price">
                                                        <?php if($shopitem->rnd_discount > 0): ?>
                                                          <?php echo e('-'.$shopitem->rnd_discount.'% '); ?><del><?php echo e($shopitem->price); ?> PD</del> <?php echo e(ceil($shopitem->price * (100 - $shopitem->rnd_discount) / 100)); ?> PD <?php echo e($shopitem->count > 1 ? 'за '.$shopitem->count : ''); ?> 
                                                        <?php else: ?>
