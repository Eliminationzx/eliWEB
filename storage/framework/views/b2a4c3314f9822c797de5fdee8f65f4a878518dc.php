            ...
            <div class="wrapper wrapper-content animated fadeInUp">
                <div class="ibox">
                    <div class="ibox-title">
					    <h5>Список категорий товаров</h5>
                        ...
                        <div class="ibox-tools">
                            <a href="<?php echo e(route('admin.shopcategories.create')); ?>" class="btn btn-primary btn-xs"><i
                                        class="fa fa-plus"></i> Добавить категорию
                            </a>
                        </div>
                                    ...
                                    <tr id="<?php echo e($shopcategory->id); ?>">
                                        ...
                                        <td class="project-title">
                                            <small><?php if($shopcategory->updated_at == $shopcategory->created_at): ?>
                                                    Создана <?php echo e($shopcategory->created_at); ?>

                                                <?php else: ?>
                                                    Обновлена <?php echo e($shopcategory->updated_at); ?>
