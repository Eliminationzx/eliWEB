                                            ...
                                            <div class="ibox-content product-box">
                                                ...
                                                <div class="product-desc">
                                                    <span class="product-price">
                                                        ...
                                                        <?php echo e('-'.$shopitem['rnd_discount'].'% '); ?><del><?php echo e($shopitem['price']); ?> Н</del> <?php echo e(ceil($shopitem['price'] * (100 - $shopitem['rnd_discount']) / 100)); ?> Н <?php echo e($shopitem['count'] > 1 ? 'за '.$shopitem['count'].'шт.' : ''); ?> 
                                                        <?php else: ?>
                     ...
                     <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            <a href="<?php echo e(route('admin.shop.formcreate')); ?>" class="btn btn-primary btn-xs"><i
                                        class="fa fa-plus"></i> Добавить товар
                            </a>
                        </div>
                        <?php endif; // Entrust::can ?>
                    </div>
